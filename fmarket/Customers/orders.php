            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav navbar-right navbar-user">
					...
					<li class="dropdown user-dropdown">
                        <a href="cart_items.php"> Cart<span class='glyphicon glyphicon-shopping-cart'></span></a>
...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
		...
		echo "<tr>";
		echo "<tr>";
		echo "<td colspan='3' align='right' style='font-size:20px;'>Customer: ".$user_firstname." ".$user_lastname." | <span style='color:blue'>Total Price Ordered:</span>";
		echo "</td>";
		
		echo "<td style='font-size:18px;'><span style='color:blue;'>Kes ".$totalx."</span>";
		echo "</td>";
		...
		echo "</div>";
		echo "<br />";
		echo '<div class="alert alert-default" style="background-color:#f5e8e6;">

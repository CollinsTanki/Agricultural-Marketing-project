...
<body >
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img class="logo-custom" src="assets/img/logoo.png" alt=""  /></a>
            </div>
            <div class="navbar-collapse collapse move-me">
                <ul class="nav navbar-nav navbar-right">
                    <li ><a href="#home">HOME</a></li>                    
                     <li><a href="#testimonials-sec">TESTIMONIALS</a></li>
                     <li><a href="#brand-sec">PRODUCTS</a></li>
 ...
 <div class="container">
               ...
               <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        <!-- Slider 01 -->
                        <li>
                              <h3>High Quality Farm  Products</h3>
                        ...
                        <!-- Slider 03 -->
                        <li>
                            <h3>High Quality Farms Products</h3>
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO THE FARMERS MARKET <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
    ...
    <!--HOME SECTION TAG LINE END-->   
         <div id="testimonials-sec" class="container set-pad" >
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/image4.jpg" style="width:100px;height:100px;" />
                   <h3 > Collins Tanki</h3>
                 <hr />
                       <hr />
                   <p >
                       This Platform is one of the best in the market they give us
					   what our customers need.
                   </p>
				   </center>
               <a class="btn btn-info btn-set"  >Allium Vegetables Seller</a>
                </div>
                   </div>
				   ...
				   <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/image2.jpg" style="width:100px;height:100px;" />
                   <h3 >David  <br />Murit</h3>
                 <hr />
                       <hr />
                   <p >
				   ...
				   <br />
               <a class="btn btn-info btn-set"  >Green leafy vegetables retailer</a>
                </div>
                   </div>
				    ...
				    <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/image1.jpg" style="width:100px;height:100px;" />
                   <h3 >Ido <br /> Timon</h3>
                 <hr />
                       <hr />
                   <p >
               ...
               <a class="btn btn-info btn-set"  >Root Vegetables seller</a>
                </div>
                   </div>
                 ...
                 <hr />
				   ...
				   <br />
				   <br />
               <a class="btn btn-info btn-set"  >Cruciferous vegetable seller</a>
                </div>
                   </div>
             ...
             <div class="row text-center">
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     ...
                     <p data-scroll-reveal="enter from the bottom after 0.3s" >
                     You can choose your favorite Vegetables category.
                         </p><br />
       ...
       <div class="col-4">
            <img src="assets/img/cabbage.jpg">
        ...
        <div class="col-4">
                <img src="assets/img/onions.jpg">
                <h4>Allium vegetables</h4>
                <div class="rating">
                     <i class="fa fa-star"></i>
                     <i class="fa fa-star"></i>
                     <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                    <img src="assets/img/spinach.jpg">
                    <h4>Leafy Green vegetables</h4>
                    <div class="rating">
                         <i class="fa fa-star"></i>
                         <i class="fa fa-star"></i>
                         <i class="fa fa-star"></i>
...
<br />
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div >
                        <h4><strong>Call:</strong>  +254 710566212 </h4>
                        <h4><strong>Email: </strong>Fmarket@gmail.com</h4>
                    </div>
                    </div>

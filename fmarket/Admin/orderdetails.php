		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
                <tr>
				 ...
				 <td style='font-size:18px;'><span style='color:blue;'><?php echo $user_firstname; ?> <?php echo $user_lastname; ?></td>
				 <td><?php echo $order_name; ?></td>
				 <td>Kes <?php echo $order_price; ?></td>
				 <td><?php echo $order_quantity; ?></td>
				 <td style='font-size:18px;'><span style='color:red;'>Kes <?php echo $order_total; ?></td>
